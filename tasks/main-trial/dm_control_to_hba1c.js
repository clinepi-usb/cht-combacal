...
const { appliesIfDmControlToHba1c, appliesIfDmControlToSmallFormsComplete6m} = require('../applies');
const {preLoadingToAll} = require('../preloading');
const {calculateDueDateForDmControltoHba1c} = require('../dueDate');

module.exports =
  {
    name: 'combacal.main-trial.dm-control-to-hba1c',
    ...
    appliesIf: function (contact, report) {
      ...
      return (
        ...
        appliesIfDmControlToHba1c(contact.reports) &&
    ...
    events: [{
      id: 'dm-control-hba1c-event',
      start: DUE_DATE_TEST_DAYS,
      end: 150,
      dueDate: function(event, contact) {
        return calculateDueDateForDmControltoHba1c(contact.reports);
      }
    }]
  };
