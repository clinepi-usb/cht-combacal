const { REPORT, TASK_EXPIRY_PERIOD, DUE_DATE_TEST_DAYS, DM_INTERVENTION_FORM, DM_TWIC_STATUS_FIELD, DM_TWIC_STATUS} = require('../../data/ENUM');
...
const { calculateDueDateForDmInterventionSelfTwic } = require('../dueDate');

module.exports =
{
  name: 'combacal.dm-intervention-dm-intervention-twic',
  ...
  events: [{
    id: 'dm_intervention-twic-event-self-twic',
    ...
    dueDate: function(event, contact) {
      ...
      return calculateDueDateForDmInterventionSelfTwic(contact.reports);
    }
  }]
};
