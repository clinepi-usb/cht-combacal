...
const { appliesIfDmInterventionToHba1c12m} = require('../applies');
const {preLoadingToAll} = require('../preloading');
const {calculateDueDateForDmInterventiontoHba1c12m} = require('../dueDate');

module.exports =
  {
    name: 'combacal.main-trial.dm-int-to-hba1c-12m',
    ...
    appliesIf: function (contact, report) {
      ...
      return (
        ...
        appliesIfDmInterventionToHba1c12m(contact.reports) &&
    ...
    events: [{
      id: 'dm-int-hba1c-event-12m',
      start: DUE_DATE_TEST_DAYS,
      end: 150,
      dueDate: function(event, contact) {
        return calculateDueDateForDmInterventiontoHba1c12m(contact.reports);
      }
    }]
  };
