...
const { calculateDueDateForBpControlSelfTwic } = require('../dueDate');

module.exports =
{
  name: 'combacal.bp-control-bp-control-twic',
  ...
  events: [{
    ...
    dueDate: function(event, contact) {
      ...
      return calculateDueDateForBpControlSelfTwic(contact.reports);
    }
  }]
};
